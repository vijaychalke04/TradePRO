...
// INSTRUMENTS
// =============================================
const COM_TOKENS = ["257681","254721","258847","259304"]; // MCX
...
function enrichEngine(market, engine){
  ...
  const isIndex = String(market?.exchange || "").toUpperCase()==="NSE" && (nm.includes("NIFTY") || nm.includes("BANK") || nm.includes("FIN") || nm.includes("VIX"));
